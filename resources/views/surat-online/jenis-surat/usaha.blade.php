...
@section('content')
    ...
    <div style="">
        ...
        <table style="margin-left: 2.5rem; line-height: 1.75;">
            ...
            <tr>
                ...
                <td style="text-align: center;">:</td>
                <td>{{ $certificate->no_hp ?? '08123456789' }}</td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td style="text-align: center;">:</td>
                <td>{{ $certificate->nama_usaha ?? 'Usaha Buah' }}</td>
            </tr>
            <tr>
                <td style="vertical-align: top;">Jenis Usaha</td>
                <td style="text-align: center;">:</td>
                <td>{{ $certificate->business_type ?? 'Usaha Buah' }}</td>
            </tr>
            <tr>
                <td style="vertical-align: top;">Alamat Usaha</td>
                <td style="text-align: center;">:</td>
                <td>{{ $certificate->bussiness_address ?? 'Usaha Buah' }}</td>
            </tr>
    ...
    <div style="margin-top: 0.5rem;  line-height: 1.625;">
        <p style="text-align: justify;">
            ...
            yang terletak di
            {{ $certificate->bussiness_address ?? 'RW 01, Kelurahan Tuwung, Kecamatan Barru, Kabupaten Barru' }}.
