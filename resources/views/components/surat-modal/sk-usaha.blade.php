            ...
            <div class="space-y-6">
                ...
                <div class="grid grid-cols-1 gap-6 gap-x-0 lg:gap-x-10 lg:grid-cols-2">
                    <div class="space-y-2">
                        ...
                        <div>
                            <textarea
                                class="w-full px-3 py-2 min-h-[100px] text-black transition border rounded-md focus:ring-4 focus:ring-slate-200/75 @error('businessType') border-red-500 @else border-slate-700 @enderror focus:border-black"
