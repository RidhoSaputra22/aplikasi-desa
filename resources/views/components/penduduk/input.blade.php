        ...
        <form wire:submit.prevent="submit" class="space-y-10">
            <div class="space-y-6">
                ...
                <div class="grid grid-cols-1 gap-6 gap-x-0 lg:gap-x-10 lg:grid-cols-2">
                    ...
                    <div class="space-y-2">
                        <label for="pemasukanBulanan" class="font-medium">Pemasukan Bulanan</label>
                        <div>
                            <input type="number" id="pemasukanBulanan" wire:model="pemasukanBulanan"
                                class="w-full  text-black transition border rounded-md focus:ring-4 focus:ring-slate-200/75 border-slate-700 focus:border-black">
                            @error('pemasukanBulanan')
                                <p class="text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                    </div>
                    ...
                    <div class="space-y-2">
                        <label for="bantuan" class="font-medium">Bantuan</label>
                        <div>
                            <select id="bantuan" wire:model="bantuan"
                                class="w-full  text-black bg-white border rounded-md focus:ring-4 focus:ring-slate-200/75 border-slate-700 focus:border-black">
                                <option value="">Pilih Bantuan</option>
                                @foreach ($jenisBantuan as $bantuan)
                                    <option value="{{ $bantuan->id }}">{{ $bantuan->nama_bantuan }}
                                    </option>
                                @endforeach
                            </select>
                            @error('bantuan')
                    ...
                    <div class="space-y-2">
                        <label for="kemiskinan" class="font-medium">Kategori Kemiskinan</label>
                        <div>
                            <select id="kemiskinan" wire:model="kemiskinan"
                                class="w-full  text-black bg-white border rounded-md focus:ring-4 focus:ring-slate-200/75 border-slate-700 focus:border-black">
                                <option value="">Pilih Kategori Kemiskinan</option>

                                @foreach ($kemiskinanOptions as $kategori)
