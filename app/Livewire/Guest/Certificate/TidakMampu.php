...
class TidakMampu extends ModalComponent
{
    ...
    public function mount()
    {
        if (env('APP_DEBUG')) {
            // Data diri
            $this->name = 'Rini Suryani';
            $this->idCardNumber = '3201234567890127';
            $this->placeOfBirth = 'Palembang';
            $this->dayOfBirth = 18;
            $this->monthOfBirth = 9;
            $this->yearOfBirth = 1985;
            $this->religion = 'Islam';
            $this->gender = 'P';
            $this->profession = 'Ibu Rumah Tangga';
            $this->address = 'Jl. Kenanga No. 123, RT 002/RW 004, Kelurahan Mekar Sari, Kecamatan Tambun Barat, Kabupaten Bekasi, Jawa Barat';

            // Data keterangan
            $this->usedFor = 'Pengajuan bantuan sosial dan keringanan biaya rumah sakit';
        }
    }
    ...
    public function submit()
    {
        ...
        try {
            ...
            $attachmentPath = null;
            if ($this->attachment) {
                $attachmentPath = $this->attachment->store('certificates/tidak-mampu', 'local');
            }
    ...
    {
        return view('components.surat-modal.sk-tidak-mampu');
    }
}