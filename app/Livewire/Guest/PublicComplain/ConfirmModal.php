            ...
            <div class="flex flex-col items-center space-y-10">
                ...
                <div class="space-y-4">
                    <p class="text-2xl font-semibold leading-snug text-center">
                        Berhasil membuat pengaduan dengan kode <span class="font-bold text-green-600">{{ $code }}</span>
                    </p>
                </div>
                <div class="flex justify-center">
                    <a href="{{ route('pengaduan-masyarakat.bukti', ['code' => $code]) }}" target="_blank" class="flex items-center justify-center px-4 py-2 space-x-2 text-white transition bg-green-600 border border-green-600 rounded-md hover:bg-opacity-90 focus:ring-4 focus:focus:ring-slate-200/75">
