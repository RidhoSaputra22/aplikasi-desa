...
namespace App\Filament\Admin\Resources\TidakMampuCertificates\Widgets;

use Filament\Widgets\StatsOverviewWidget;
use Filament\Widgets\StatsOverviewWidget\Stat;

class TidakMampuCertStat extends StatsOverviewWidget
{
    protected function getHeading(): ?string
    {
        return 'Analitik Surat Tidak Mampu';
    }
    ...
    {
        $data = \App\Models\TidakMampuCertificate::all();
        $data = [
            'count' => $data->count(),
