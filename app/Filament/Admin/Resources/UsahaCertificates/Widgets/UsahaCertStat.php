...
namespace App\Filament\Admin\Resources\UsahaCertificates\Widgets;

use Filament\Widgets\StatsOverviewWidget;
use Filament\Widgets\StatsOverviewWidget\Stat;

class UsahaCertStat extends StatsOverviewWidget
{
    protected function getHeading(): ?string
    {
        return 'Analitik Surat Keterangan Usaha';
    }
    ...
    {
        $data = \App\Models\UsahaCertificate::all();
        $data = [
            'count' => $data->count(),
