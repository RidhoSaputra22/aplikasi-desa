...
namespace App\Filament\Admin\Resources\UsahaCertificates\Tables;
    ...
    public static function configure(Table $table): Table
    {
        return $table
            ...
            ->recordActions([
                ...
                Action::make('view')
                    ->label('Lihat Surat')
                    ->url(fn($record) => route('surat-online.lihat', ['jenis' => CertificateType::USAHA, 'code' => $record->code]))
                    ->openUrlInNewTab()
                    ->color('info')
                    ->icon('heroicon-o-eye'),
                Action::make('confirm')
